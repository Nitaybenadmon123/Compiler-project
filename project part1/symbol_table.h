...
// הצהרות פונקציות לטיפול במשתנים
void insert_checked_variable(const char* name, DataType type);

// הצהרות פונקציות לטיפול בפונקציות
...
// הצהרות פונקציות לטיפול בטיפוסי פרמטרים
